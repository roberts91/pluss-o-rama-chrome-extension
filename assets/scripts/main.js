...
(function($) {
    ...
    // Make a jQuery plugin ? -> https://learn.jquery.com/plugins/basic-plugin-creation/
    
    // Publish extension -> https://chrome.google.com/webstore/developer/dashboard
    ...
    // Example: http://www.tb.no/sport/svomming/tonsberg/stenger-svommehallen-i-over-to-maneder/s/5-76-286130
    
    // Alignment: http://bed.api.no/api/acpcomposer/v1.1/content/5-76-287183
    ...
    */
    ...
    $.fn.loader = function(display)
    {
        ...
        {
            // Fade out
            $('#pluss-o-rama-loader').fadeOut(500, function(){
    ...
    $.fn.loadStory = function( article_id, data )
    {
        ...
        var article_html_build = '<div class="am-article-summary am-txt--medium am-txt--lead "><p>' + data.leadText + '</p></div>';
        ...
        console.log(article_body_object);
